        ...
        <div className="flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center w-full gap-y-10">
                ...
                <div className="text-center">
                    <p className="text-secondary text-sm"><b>email</b>: amanoac@umich.edu</p>
                    <p className="text-secondary text-sm"><b>github</b>: <a href="https://github.com/aaronamano" className='text-blue-700'>github.com/aaronamano</a></p>
                    <p className="text-secondary text-sm"><b>twitter</b>: <a href="https://x.com/aaronamano" className='text-blue-700'>x.com/aaronamano</a></p>
                    <p className="text-secondary text-sm"><b>linkedin</b>: <a href="https://linkedin.com/in/aaronamano" className='text-blue-700'>linkedin.com/in/aaronamano</a></p>
                </div>
